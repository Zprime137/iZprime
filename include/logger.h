...
/**
 * @brief Convenience function for logging test results.
 *
 * This function logs test results to the console, indicating pass or fail status.
 *
 * @param result The result of the test (1 for pass, 0 for fail).
 * @param test_id The identifier for the test.
 * @param unit_name The name of the unit being tested.
 * @param format The format string for the log message.
 */
void log_test(int result, int test_id, const char *unit_name, const char *format, ...) LOGGER_FORMAT_PRINTF(4, 5);

/**
 * @brief Logs a summary of test results for a module.
 *
 * This function prints a summary of the number of passed and failed tests
 * for a given module to the console.
 *
 * @param module_name The name of the module being tested.
 * @param passed The number of tests that passed.
 * @param failed The number of tests that failed.
 * @param verbose If non-zero, it suggests verbose mode if there are errors.
 */
