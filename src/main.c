/**
 * @file main.c
 * @brief Minimal example program using iZ sieve entry points.
 */
...
{
    // example using sieve algorithms defined in iZ_api.h to get an array of primes up to n
    uint64_t n = pow(10, 9); // 1 billion
    ...
    // UI64_ARRAY *primes = SiZm_vy(n); // unordered output (fast); OK for counting
